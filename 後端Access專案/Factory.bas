...
Public Function GetCleaner(ByVal cleaningType As String) As ICleaner
    Select Case cleaningType
        ...
        Case "OBU_AC5411B"
            ...
            GetCleaner.Initialize 1, 1, , , Array("小計", "總收入", "總支出", "純益"), Array("J", "H", "F", "E", "D", "A"), Array()
        Case "DBU_CM2810"
            Set GetCleaner = New CleanerRowsColsDelete
            GetCleaner.Initialize 1, 1, 2, 3, Array("主管", "TWD", "總計"), Array("Q", "O"), Array()
        Case "DBU_DL9360"
            Set GetCleaner = New CleanerRowsColsDelete
            GetCleaner.Initialize 1, 2, 2, 3, Array("交易"), Array("K"), Array()
            '*******要測試為什麼isempty和其他方法刪除不掉空格row，因為lastRow沒有那一行
        Case "OBU_DL6320"
            Set GetCleaner = New CleanerRowsColsDelete
            GetCleaner.Initialize 1, 1, 2, 2, Array("總計", "襄理"), Array("R", "Q", "O", "N", "M"), Array()
        Case "DBU_DL6850"
            Set GetCleaner = New CleanerRowsColsDelete
            GetCleaner.Initialize 1, 1, 2, 2, Array("小計", "總計", "主管"), Array("L"), Array()
        Case "DBU_AC5092B"
            Set GetCleaner = New CleanerRowsColsDelete
            GetCleaner.Initialize 1, 1, 2, 3, Array("主管"), Array("I", "E"), Array("RemoveCommaCols", 4, "RemoveCommaCols", 8)
        ...
        Case "BillTransactionByTradeDate"
            ' 統一編號要補零（F 欄）
            Set GetCleaner = New CleanerOMReport
            GetCleaner.Initialize , , , , , , Array("RemoveSpaceCols", 4, "RemovePercentCols", 19)

        Case "BillTransactionBySettlementDate"
            ' 統一編號要補零（F 欄）
            Set GetCleaner = New CleanerOMReport
            GetCleaner.Initialize , , , , , , Array("RemoveSpaceCols", 4, "RemovePercentCols", 19)
        ...
        Case "BondTransactionDetails", "BondRiskPositionBalance", "BondRSHoldingDetails"
            Set GetCleaner = New CleanerOMReport
            GetCleaner.Initialize , , , , , , Array()

        Case "PNCDCAL"
            Set GetCleaner = New CleanerPNCDCAL
