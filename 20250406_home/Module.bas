...
Public Sub Process_F1_F2()
    ...
    dataRanges = Array("A:B", "C:D", "E:F", "G:H", "I:J") ' 這裡假設 Cur 在前一欄, Value 在後一欄
    ...
    For i = LBound(transactionTypes) To UBound(transactionTypes)
        ...
        For j = 2 To lastRow ' 假設第1列是標題，從第2列開始
            ...
            curValue = xlsht.Cells(j, currCol + 1).Value ' 貨幣數值
            
            ' 確保 Value 為數字，且 Cur 是已定義的貨幣
            If IsNumeric(curValue) And curDict.Exists(curCode) Then
                curDict(curCode) = curValue ' 若要累加請改成 curDict(curCode) = curDict(curCode) + curValue
            End If
        Next j
...
Public Sub Process_AI602()
    ...
    xlsht.Range("CNY1_其他金融資產_淨額").Value = FVOCI_GovDebt_Cost
    rpt.SetField "CNY1", "CNY1_其他金融資產_淨額", FVOCI_GovDebt_Cost

    xlsht.Range("CNY1_其他").Value = FVOCI_GovDebt_BookValue
    rpt.SetField "CNY1", "CNY1_其他", FVOCI_GovDebt_BookValue

    xlsht.Range("CNY1_資產總計").Value = AC_GovDebt_Cost
    rpt.SetField "CNY1", "CNY1_資產總計", AC_GovDebt_Cost

    xlsht.Range("CNY1_其他金融負債").Value = AC_GovDebt_BookValue
    rpt.SetField "CNY1", "CNY1_其他金融負債", AC_GovDebt_BookValue

    xlsht.Range("CNY1_其他什項金融負債").Value = sum_GovDebt_Cost
    rpt.SetField "CNY1", "CNY1_其他什項金融負債", sum_GovDebt_Cost

    xlsht.Range("CNY1_負債總計").Value = sum_GovDebt_BookValue
    rpt.SetField "CNY1", "CNY1_負債總計", sum_GovDebt_BookValue


        xlsht.Range("CNY1_其他金融資產_淨額").Value = FVOCI_CompanyDebt_Cost
    rpt.SetField "CNY1", "CNY1_其他金融資產_淨額", FVOCI_CompanyDebt_Cost

    xlsht.Range("CNY1_其他").Value = FVOCI_CompanyDebt_BookValue
    rpt.SetField "CNY1", "CNY1_其他", FVOCI_CompanyDebt_BookValue

    xlsht.Range("CNY1_資產總計").Value = AC_CompanyDebt_Cost
    rpt.SetField "CNY1", "CNY1_資產總計", AC_CompanyDebt_Cost

    xlsht.Range("CNY1_其他金融負債").Value = AC_CompanyDebt_BookValue
    rpt.SetField "CNY1", "CNY1_其他金融負債", AC_CompanyDebt_BookValue

    xlsht.Range("CNY1_其他什項金融負債").Value = sum_CompanyDebt_Cost
    rpt.SetField "CNY1", "CNY1_其他什項金融負債", sum_CompanyDebt_Cost

    xlsht.Range("CNY1_負債總計").Value = sum_CompanyDebt_BookValue
    rpt.SetField "CNY1", "CNY1_負債總計", sum_CompanyDebt_BookValue


        xlsht.Range("CNY1_其他金融資產_淨額").Value = FVOCI_FinanceDebt_Cost
    rpt.SetField "CNY1", "CNY1_其他金融資產_淨額", FVOCI_FinanceDebt_Cost

    xlsht.Range("CNY1_其他").Value = FVOCI_FinanceDebt_BookValue
    rpt.SetField "CNY1", "CNY1_其他", FVOCI_FinanceDebt_BookValue

    xlsht.Range("CNY1_資產總計").Value = AC_FinanceDebt_Cost
    rpt.SetField "CNY1", "CNY1_資產總計", AC_FinanceDebt_Cost

    xlsht.Range("CNY1_其他金融負債").Value = AC_FinanceDebt_BookValue
    rpt.SetField "CNY1", "CNY1_其他金融負債", AC_FinanceDebt_BookValue

    xlsht.Range("CNY1_其他什項金融負債").Value = sum_FinanceDebt_Cost
    rpt.SetField "CNY1", "CNY1_其他什項金融負債", sum_FinanceDebt_Cost

    xlsht.Range("CNY1_負債總計").Value = sum_FinanceDebt_BookValue
    rpt.SetField "CNY1", "CNY1_負債總計", sum_FinanceDebt_BookValue
...
Public Sub Process_AI240()
    ...
    xlsht.Range("CNY1_其他金融資產_淨額").Value = buyAmountTWD_0to10
    rpt.SetField "CNY1", "CNY1_其他金融資產_淨額", buyAmountTWD_0to10

    xlsht.Range("CNY1_其他").Value = buyAmountTWD_11to30
    rpt.SetField "CNY1", "CNY1_其他", buyAmountTWD_11to30

    xlsht.Range("CNY1_資產總計").Value = buyAmountTWD_31to90
    rpt.SetField "CNY1", "CNY1_資產總計", buyAmountTWD_31to90

    xlsht.Range("CNY1_其他金融負債").Value = buyAmountTWD_91to180
    rpt.SetField "CNY1", "CNY1_其他金融負債", buyAmountTWD_91to180

    xlsht.Range("CNY1_其他什項金融負債").Value = buyAmountTWD_181to365
    rpt.SetField "CNY1", "CNY1_其他什項金融負債", buyAmountTWD_181to365

    xlsht.Range("CNY1_負債總計").Value = buyAmountTWD_over365
    rpt.SetField "CNY1", "CNY1_負債總計", buyAmountTWD_over365
    

    xlsht.Range("CNY1_其他金融資產_淨額").Value = sellAmountTWD_0to10
    rpt.SetField "CNY1", "CNY1_其他金融資產_淨額", sellAmountTWD_0to10

    xlsht.Range("CNY1_其他").Value = sellAmountTWD_11to30
    rpt.SetField "CNY1", "CNY1_其他", sellAmountTWD_11to30

    xlsht.Range("CNY1_資產總計").Value = sellAmountTWD_31to90
    rpt.SetField "CNY1", "CNY1_資產總計", sellAmountTWD_31to90

    xlsht.Range("CNY1_其他金融負債").Value = sellAmountTWD_91to180
    rpt.SetField "CNY1", "CNY1_其他金融負債", sellAmountTWD_91to180

    xlsht.Range("CNY1_其他什項金融負債").Value = sellAmountTWD_181to365
    rpt.SetField "CNY1", "CNY1_其他什項金融負債", sellAmountTWD_181to365

    xlsht.Range("CNY1_負債總計").Value = sellAmountTWD_over365
    rpt.SetField "CNY1", "CNY1_負債總計", sellAmountTWD_over365
