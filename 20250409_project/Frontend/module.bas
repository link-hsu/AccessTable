...
Public Sub Process_FB3A()
    ...
    If (lastRow > 1) Then
        ...
        For i = 2 To lastRow
            ...
            rpt.AddDynamicField "FOA", "FB3A_BankCode", "C" & CStr(targetRow), CStr(Format(BankCode, "0000"))
            rpt.AddDynamicField "FOA", "FB3A_Amount", targetCol & CStr(targetRow), CStr(Amount)
            
            InsertIntoTable gDBPath, "MonthlyDeclarationReport", gDataMonthString, "FB3A", "FOA|FB3A_BankCode", CStr(Format(BankCode, "0000")), "C" & CStr(targetRow)
...
Public Sub Process_FB5A()
    ...
    Else
        ...
        Debug.Print reportTitle & ": " & queryTable_1 & " 資料表有資料，此表單尚無有資料紀錄，尚請確認。"
    End If
    ...
    Else
        ...
        Debug.Print reportTitle & ": " & queryTable_2 & " 資料表有資料，此表單尚無有資料紀錄，尚請確認。"
    End If
...
Public Sub Process_FM2()
    ...
    For i = 2 To lastRow
        ...
        If (Not IsEmpty(xlsht.Cells(i, "P").Value)) Then
            ...
            rpt.AddDynamicField "FOA", "FM2_BankCode", "C" & CStr(targetRow), CStr(Format(BankCode, "0000"))
            rpt.AddDynamicField "FOA", "FM2_Amount", targetCol & CStr(targetRow), CStr(Amount) 
            
            InsertIntoTable gDBPath, "MonthlyDeclarationReport", gDataMonthString, "FM2", "FOA|FM2_BankCode", CStr(Format(BankCode, "0000")), "C" & CStr(targetRow)
