...
Public Function GetConfigsReturnDict(Optional ByVal reportType As Variant, _
    ...
    Do While Not rsFilePaths.EOF
        ...
        If Not checkOpt Then
            ...
            If pathID = "OBU_DL6320" Or pathID = "DBU_CM2810" Or pathID = "DBU_DL9360" Or pathID = "DBU_DL6850" Then fullFilePath = copyFilePath & "\" & pathName & "." & extensionFormat
        Else
            For Each oneType In reportType
                ...
                If (oneType =  pathID) And ((pathID = "OBU_DL6320")  Or (pathID = "DBU_CM2810") Or (pathID = "DBU_DL9360") Or (pathID = "DBU_DL6850")) Then fullFilePath = copyFilePath & "\" & pathName & "." & extensionFormat
