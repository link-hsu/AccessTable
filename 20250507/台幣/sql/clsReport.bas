...
Public Sub Init(ByVal reportName As String, _
    ...
    Select Case reportName
        Case "TABLE10"
            AddDynamicField reportName, "TABLE10_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE15A"
            AddDynamicField reportName, "TABLE15A_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE15B"
            AddDynamicField reportName, "TABLE15B_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE16"
            AddDynamicField reportName, "TABLE16_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE20"
            AddDynamicField reportName, "TABLE20_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE22"
            AddDynamicField reportName, "TABLE22_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE23"
            AddDynamicField reportName, "TABLE23_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE24"
            AddDynamicField reportName, "TABLE24_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE27"
            AddDynamicField reportName, "TABLE27_申報時間", "", dataMonthStringROC_F1F2
        Case "TABLE36"
            AddDynamicField reportName, "TABLE36_申報時間", "", dataMonthStringROC_F1F2
        Case "AI233"
            AddDynamicField reportName, "AI233_申報時間", "", dataMonthStringROC_F1F2
        Case "AI345"
            AddDynamicField reportName, "AI345_申報時間", "", dataMonthStringROC_F1F2
        Case "AI405"
            AddDynamicField reportName, "AI405_申報時間", "", dataMonthStringROC_F1F2
        Case "AI410"
            AddDynamicField reportName, "AI410_申報時間", "", dataMonthStringROC_F1F2
        Case "AI430"
            AddDynamicField reportName, "AI430_申報時間", "", dataMonthStringROC_F1F2
        Case "AI601"
            AddDynamicField reportName, "AI601_申報時間", "", dataMonthStringROC_F1F2
        Case "AI605"
            AddDynamicField reportName, "AI605_申報時間", "", dataMonthStringROC_F1F2
